...
CREATE TABLE IF NOT EXISTS `mydb`.`permisologia` (
  ...
  INDEX `fk_permisologia_modulos1_idx` (`idmodulos` ASC),
  INDEX `fk_permisologia_perfil1_idx` (`idperfil` ASC),
  CONSTRAINT `fk_permisologia_modulos1`
    FOREIGN KEY (`idmodulos`)
    REFERENCES `mydb`.`modulos` (`idmodulos`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_permisologia_perfil1`
    FOREIGN KEY (`idperfil`)
    REFERENCES `mydb`.`perfil` (`idperfil`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
